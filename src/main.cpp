...
uint256 hashGenesisBlock("0x3ab95f481b4a737cd67587a2d90e4c2ffd7a3983b652ac5cc5dec311f8ff5410");
...
const string strMessageMagic = "MapleDrop Signed Message:\n";
...
static const int64 nTargetTimespan = 24 * 60 * 60; // MapleDrop: 1 days
static const int64 nTargetSpacing = 2 * 60; // MapleDrop: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal MapleDrop miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MapleDrop", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2689c2ece1a5b7dd397dbad5b7c4dfdb350f6771b6d8b274d5909169fa6074b6");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Bowe Bergdahl returns to USA";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1402760424; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 791460;

        if (fTestNet)
        {
            block.nTime    = 1402757557;
            block.nNonce   = 1694375;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc635d930edacff7330c3ab4bc8c8b8004e903b4eebd4a1d337be99e2e727223d"));
